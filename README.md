...
3. Install [**SAMD_TimerInterrupt** library](https://platformio.org/lib/show/xxxxx/SAMD_TimerInterrupt) by using [Library Manager](https://platformio.org/lib/show/xxxxx/SAMD_TimerInterrupt/installation). Search for **SAMD_TimerInterrupt** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
